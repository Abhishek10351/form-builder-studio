...
export const AuthProvider = ({ children }: AuthProviderProps) => {
  ...
  useEffect(() => {
    console.log('AuthProvider state:', { isAuthenticated, token: !!token, user: !!user, isLoading, hasFetched: hasFetchedRef.current });
    ...
    if (isAuthenticated && token && !user && !isLoading && !hasFetchedRef.current) {
